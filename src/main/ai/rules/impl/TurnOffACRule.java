...
public class TurnOffACRule implements Rule {
    private static final Logger logger = LoggerUtil.getLogger(TurnOffACRule.class.getName());
    ...
    public boolean evaluate(KnowledgeBase kb) {
        try {
            ...
            return temp != null && temp <= 20 && "on".equals(acStatus);
    ...
    public void execute(KnowledgeBase kb) {
        logger.info("Turning off the air conditioner.");
